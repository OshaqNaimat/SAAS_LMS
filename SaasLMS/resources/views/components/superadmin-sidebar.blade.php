<aside class="sidebar" id="sidebar">
    ...
    <div class="sidebar-section">
        ...
        <a class="nav-item {{ request()->is('super-admin-dashboard') ? 'active' : '' }}" href="/super-admin-dashboard">
    ...
    <div class="sidebar-section">
        ...
        <a class="nav-item {{ request()->is('super-admin-analytics') ? 'active' : '' }}" href="/super-admin-analytics">
            <i class="bi bi-bar-chart-fill"></i> Analytics
        </a>
        <a class="nav-item {{ request()->is('super-admin-settings') ? 'active' : '' }}" href="/super-admin-settings">
