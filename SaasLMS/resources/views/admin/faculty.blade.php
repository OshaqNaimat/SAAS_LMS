        ...
        <main class="flex-1 flex flex-col min-w-0 overflow-y-auto p-6 lg:p-8">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
                ...
                <div class="flex items-center gap-3 shrink-0 sm:self-center">
                    <button onclick="toggleModal('teacherModal')"
            ...
            <div
                ...
                <div class="header-bg p-4 flex justify-between items-center">
                    <h3 class="text-base font-bold flex items-center gap-2 text-white"><i
                            class="fa-solid fa-paper-plane text-blue-400"></i> Invite Faculty Member</h3>
                    <button onclick="toggleModal('teacherModal')" class="text-gray-400 hover:text-white"><i
                            class="fa-solid fa-xmark"></i></button>
                </div>
                <form class="p-5 space-y-4" onsubmit="event.preventDefault(); toggleModal('teacherModal');">
                    <div>
                    ...
                    <div>
                        <label class="block text-xs font-semibold text-gray-400 mb-1">Academic Department</label>
                        <input type="text" placeholder="e.g. Computer Science"
                            class="w-full bg-slate-900 border border-slate-700 rounded-xl px-3.5 py-2 text-sm text-white focus:outline-none focus:border-blue-500"
                            required>
                    </div>
                    <div>
                        <label class="block text-xs font-semibold text-gray-400 mb-1">Institutional Email</label>
                        <input type="email" placeholder="name@apex.edu"
                            class="w-full bg-slate-900 border border-slate-700 rounded-xl px-3.5 py-2 text-sm text-white focus:outline-none focus:border-blue-500"
                            required>
                    </div>
                    <div class="pt-2 flex justify-end gap-3">
                        <button type="button" onclick="toggleModal('teacherModal')"
                            class="px-4 py-2 rounded-xl text-sm font-medium border border-slate-700 text-gray-400 hover:bg-slate-800">Cancel</button>
                        <button type="submit"
                            class="px-5 py-2 rounded-xl text-sm font-semibold bg-blue-600 text-white hover:bg-blue-500">Send
                            Invitation</button>
                    </div>
                </form>
            </div>
