        ...
        <main class="flex-1 flex flex-col min-w-0 overflow-y-auto p-6 lg:p-8">
            ...
            <div class="space-y-8">
                ...
                <div id="roster-students"
                    ...
                    <div class="border-t border-slate-800/60 p-5 space-y-6">
                        <h3 class="font-bold text-base text-white flex items-center gap-2 mb-2">
                            <i class="bi bi-clock-history text-purple-400"></i> Student Attendance History
                        </h3>
                        @forelse($history['students'] as $day)
                            <div
                                ...
                                <div class="w-32 shrink-0 font-bold text-white text-sm">{{ $day['date'] }}</div>
                ...
                <div id="roster-faculty"
                    ...
                    <div class="border-t border-slate-800/60 p-5 space-y-6">
                        <h3 class="font-bold text-base text-white flex items-center gap-2 mb-2">
                            <i class="bi bi-clock-history text-purple-400"></i> Faculty Attendance History
                        </h3>
